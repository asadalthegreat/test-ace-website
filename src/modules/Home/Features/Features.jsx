    ...
    <div className="flex flex-col justify-between items-center container mx-auto pl-9 pr-8 my-[137px]">
      <div className="flex justify-between items-center w-full flex-wrap">
        ...
        <div className="">
          ...
          What makes our app unique is its gamified learning experience. You&apos;ll earn points, badges, and Practice Scores as you progress through the variety of gamified material. Our app also includes flashcards and review mode that reinforce what you&apos;ve learned and provide a break from the hard stuff.
          </p>
      ...
      <div className="flex justify-between items-center w-full mt-12 flex-wrap flex-col-reverse lg:flex-row">
        <div className="mt-10 lg:mb-0">
          ...
          <p className="text-[#424242] font-secondary text-lg lg:w-[652px]">
            ...
            Looking for a fun way to motivate yourself and your friends to study harder? Test Ace has you covered! Our app includes a unique challenge feature that lets you connect with friends or random users globally, and challenge them to see who can earn the highest score. Make international friends and see who wins!
            </span>

            <span>
            Our challenge feature is a great way to get matched with other users of your level, and keep yourself and your friends engaged and motivated. Plus, you&apos;ll be able to provide support and encouragement to your friends along the way.
            </span>
          </p>
          <button className="text-[#2C5282] font-semibold text-lg px-4 py-3 flex items-center justify-between mt-6 lg:mt-12 rounded-[5px] w-[170px] relative before:-z-50 before:block before:-inset-1 before:w-[50%] before:bg-[#F6FCFF] before:absolute before:top-0 before:left-0 before:transition-all before:duration-200 before:ease-in-out hover:before:w-[100%] before:rounded-[5px]">
            Learn More
      ...
      <div className="flex justify-between items-center w-full mt-12 flex-wrap">
        ...
        <div className="lg:mt-0 mt-10">
          ...
          <p className="text-[#424242] font-secondary text-lg lg:w-[652px]">
          Our app is available for download on both iOS and Android devices, making it easy for you to learn on the go, completely free! We also offer premium membership for those students who want to work hard to earn their high score.
          </p>
